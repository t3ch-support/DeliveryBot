...
int main(int argc, char *argv[]) {
    ...
    float markerLength = 0.0277;
    int dictionaryId = 0;
    string outputFile = "outputPi.txt";
...
// Manual compile code
// g++ -std=c++17 main.cpp -o ../bin/CameraCalibrator `pkg-config --cflags --libs opencv jsoncpp`
// ./CameraCalibrator -dp="detector_params.yml" -w=5 -h=8 -sl=0.035 -ml=0.0277 -d=0 output.txt